...
public:
    ...
    bool remove(int value) {
        ...
        if (*curr) {
            ...
            *curr = (*curr)->next;
            delete temp;
            return true; // Successfully removed present
        }
        return false;   // Present not found
    }
};

//Functions for servant threads
...
//Compare and find largest temp delta
void analyzeTemperatureData() {
    ...
    //Output largest temperature delta
    std::cout << "Solution 2:\n";
